          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="text-center p-4 rounded-lg" style={{backgroundColor: '#e31a90'}} className="bg-opacity-10">
                  <div className="text-3xl font-bold" style={{color: '#e31a90'}}>72</div>
                  <div className="text-sm text-gray-600">Hours of Innovation</div>
                </div>
                <div className="text-center p-4 rounded-lg" style={{backgroundColor: '#3baf49'}} className="bg-opacity-10">
                  <div className="text-3xl font-bold" style={{color: '#3baf49'}}>300+</div>
                  <div className="text-sm text-gray-600">Total Participants</div>
                </div>
                <div className="text-center p-4 rounded-lg" style={{backgroundColor: '#52c2ec'}} className="bg-opacity-10">
                  <div className="text-3xl font-bold" style={{color: '#52c2ec'}}>5+</div>
                  <div className="text-sm text-gray-600">Years Running</div>
                </div>
                <div className="text-center p-4 rounded-lg" style={{backgroundColor: '#f6de08'}} className="bg-opacity-10">
